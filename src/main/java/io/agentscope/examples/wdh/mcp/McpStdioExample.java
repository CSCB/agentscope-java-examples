 ...
 */
package io.agentscope.examples.wdh.mcp;
...
public class McpStdioExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String npxCmd = System.getProperty("os.name").toLowerCase().contains("win")
                ? "C:\\Program Files\\nodejs\\npx.cmd"
                : "npx";
        String allowedDir = System.getProperty("os.name").toLowerCase().contains("win")
        ...
        McpClientWrapper mcpClient =
                McpClientBuilder.create("filesystem")
                        .stdioTransport(
                                npxCmd, "-y", "@modelcontextprotocol/server-filesystem", allowedDir)
                        .buildAsync()
                        .block();
                ...
                ReActAgent.builder()
                        ...
                        .sysPrompt(
                                "You are a filesystem assistant. Use the available MCP tools to "
                                        + "help the user navigate and read files under " + allowedDir + ".")
                        .model(
